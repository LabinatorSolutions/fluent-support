...
export const CreateTicketBlock = props => {
    ...
    return (
        <Fragment>
            ...
            <div className="fs_block_create_ticket" style={blockStyles}>
                <div className="fs_block_create_ticket_header">
                    <h2 className="fs_block_form_title">Submit a Support Ticket</h2>
                </div>

                <div className="fs_block_form_container">
                    <div className="fs_block_form_group">
                        <label className="fs_block_form_label">Subject</label>
                        <input
                            type="text"
                            className="fs_block_form_input"
                    ...
                    <div className="fs_block_form_group">
                        <label className="fs_block_form_label">Ticket Details</label>
                    ...
                    <div className="fs_block_form_group">
                        <p className="fs_block_form_label">File Upload</p>
                        <button className="fs_block_browse_file_button" style={secondaryButtonStyles}>Browse File</button>
                        <div className="fs_block_upload_text_container">
                            <p className="fs_block_upload_subtext">(Supported Types: Photos, CSV, PDF/Docs, Zip, JSON and max
                                file size: 2.0MB)</p>
                        </div>
                    </div>

                    <div className="fs_block_form_group">
                        <label className="fs_block_form_label">Priority</label>
                        <div className="fs_block_dropdown_container">
                            <select
                                className="fs_block_form_dropdown"
                                value={priority}
                                style={inputFieldStyle}
                    ...
                    <div className="fs_block_form_group">
                        <label className="fs_block_form_label">Email Address</label>
                        <input
                            type="text"
                            className= "fs_block_form_input"
                    ...
                    <div className="fs_block_form_actions">
                        <button
                            className="fs_block_create_ticket_submit_button"
