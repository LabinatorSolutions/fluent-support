                ...
                <div class="fs_tk_card_body">
                    <ul>
                        <li v-for="(order,order_key) in widget.orders" :key="order_key">
                            <a @click="getOrderDetails(order, widget.products)" class="fs_wc_order_link">Order #{{order.id}} </a>-<code>{{order.status}}</code>
                    ...
                    <el-card class="fs_wc_order_box-card">
                        <template #header>
                            <div class="fs_wc_card-header">
                                ...
                                <el-button :type="getType(orders.orderInfo.status)" plain>{{orders.orderInfo.status}}</el-button>
                            </div>
                        </template>
