<template>
    <div class="fs_create_response" :class="'fs_reply_type_'+type">
        ...
        <wp-editor :autofocus="true" v-if="editor_ready" v-model="response_body" :ticketId="ticket.id" :productID="ticket.product_id" :is_agent="is_agent" :is_direct_paste="true" :show-shortcodes="true" :aiIntegration="aiIntegration"
