                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <el-dropdown-item @click='(show_merge_modal=true) && (customerTickets())'>
                                        <svg width="14" style="margin-right: 4px;" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <el-dropdown-item @click='(show_watcher_modal=true)' v-if="!watchers.length">
                                        ...
                                        </svg> {{ translate('Add Bookmark')}}
                                    </el-dropdown-item>
                                    <el-dropdown-item @click='(close_ticket_silently="yes") && closeTicket()'>
                                        <el-icon><MuteNotification /></el-icon> {{translate('Close Ticket Silently')}}
                                    </el-dropdown-item>
                                </el-dropdown-menu>
                            </template>
                        </el-dropdown>
                                                ...
                                                <template #dropdown>
                                                    <el-dropdown-menu>
                                                        ...
                                                        <el-dropdown-item v-if="has_pro"
                                                                          ...
                                                                          icon="TopLeft"> {{translate('Split Ticket')}}
                                                        </el-dropdown-item>
                                                        <el-dropdown-item
