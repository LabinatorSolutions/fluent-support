...
class EmailVerification
{
    ...
    private function emailBody($email)
    {
        ...
        $emailText = sprintf('<p>Hello %s,</p><br> <p>Please click on the link below to verify your email address.</p><br>', $firstName);
        $emailText .= sprintf('<a href="%s" style="text-decoration: none;"><button style="background: #0fb779; color: #fff; border: none; padding: 12px; border-radius: 2px; cursor: pointer;">Click Here</button></a><br>', $verificationLink);
