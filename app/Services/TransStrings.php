...
class TransStrings
{
    public static function getTransStrings()
    {
        return [
            ...
            'Enter API Key' => __('Enter API Key', 'fluent-support'),
            'Bot ID' => __('Bot ID', 'fluent-support'),
            'Enter General Bot ID' => __('Enter General Bot ID', 'fluent-support'),
            ...
            'Enter Bot ID' => __('Enter Bot ID', 'fluent-support'),
            ...
            'Password is required.' => __('Password is required.', 'fluent-support'),
